...
import Mobilemenuold from './Mobilemenuold';
...
function Headertwo(props) {
    ...
    const megamenuNavItemsRef = useRef(null);
    ...
    const handleMouseOver = (e) => {
        ...
        const megamenuNavItems = megamenuNavItemsRef.current;
        const megamenuNav = megamenuRef.current.querySelector('.sub-menu .sigm-megamenu-nav');
        const tabContent = megamenuRef.current.querySelector('.sub-menu .tab-content');

        megamenuNav.querySelector('.active').classList.remove('active');
        tabContent.querySelector('.active').classList.remove('active', 'show');

        const index = Array.from(megamenuNavItems).indexOf(e.currentTarget);

        e.currentTarget.querySelector('a').classList.add('active');
        tabContent.querySelectorAll('.tab-item')[index].classList.add('active', 'show');
    };
                        ...
                        <div className="nav-menu d-lg-flex align-items-center justify-content-center">
                            ...
                            <div className="sigma-header-nav">
                                <div className="sigma-header-nav-inner">
                                    <nav>
                                        <ul className="sigma-main-menu" ref={megamenuRef}>
